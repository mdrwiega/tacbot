...
: ${TURTLEBOT_GAZEBO_MAP_FILE:=`rospack find tacbot_simulation`/maps/playground.yaml}
: ${ROBOT_GAZEBO_WORLD_FILE:=`rospack find tacbot_simulation`/worlds/w1.world}
: ${GAZEBO_RESOURCE_PATH=`rospack find tacbot_simulation`}

# Exports
export TURTLEBOT_GAZEBO_MAP_FILE
export ROBOT_GAZEBO_WORLD_FILE
